...
switch (_shop) do
{
	...
	case "COP_VITEMS_BASIC": {["Basic Police Gear (Virtual)",["medkit","water","donuts","coffee","tbacon","redgull","spikeStrip","BarGate","RoadBlockConc","RoadBlockWood","RoadCone","RoadConeStrip","RoadConeB","RoadConeStripB"]]};
	case "CIV_MARIJEANA": {["Marijuana Dealer",["cannabis seed","marijuana"]]};
};
