...
hud_fnc_loop =
{
	...
	_select ctrlSetText format["%1 Firemode", format["%1",_gunmode]];
		...
		if ( myhealth > 0 ) then
		{
			if(myHealth > 0.8) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\health6.paa'/>";
				_mylife ctrlSetStructuredText parseText format["%1",_message];
			};
			if(myHealth > 0.6) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\health5.paa'/>";
				_mylife ctrlSetStructuredText parseText format["%1",_message];
			};
			if(myHealth > 0.45) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\health4.paa'/>";
				_mylife ctrlSetStructuredText parseText format["%1",_message];
			};

			if(myHealth > 0.3) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\health3.paa'/>";
				_mylife ctrlSetStructuredText parseText format["%1",_message];
			};
			if(myHealth > 0.15) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\health2.paa'/>";
				_mylife ctrlSetStructuredText parseText format["%1",_message];
			};
			if(myHealth > 0) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\health1.paa'/>";
				_mylife ctrlSetStructuredText parseText format["%1",_message];
			};
		}
		else
		...
		if ( life_hunger < 65 ) then
		{
			...
			if(life_hunger > 60) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\food1.paa'/>";
				_myfood ctrlSetStructuredText parseText format["%1",_message];
			};
			if(life_hunger > 50) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\food2.paa'/>";
				_myfood ctrlSetStructuredText parseText format["%1",_message];
			};
			if(life_hunger > 40) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\food3.paa'/>";
				_myfood ctrlSetStructuredText parseText format["%1",_message];
			};

			if(life_hunger > 30) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\food4.paa'/>";
				_myfood ctrlSetStructuredText parseText format["%1",_message];
			};
			if(life_hunger > 15) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\food5.paa'/>";
				_myfood ctrlSetStructuredText parseText format["%1",_message];
			};
			if(life_hunger > 0) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\food6.paa'/>";
				_myfood ctrlSetStructuredText parseText format["%1",_message];
			};
		...
		if ( life_thirst < 65 ) then
		{
			if(life_thirst > 60) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\drink1.paa'/>";
				_mydrink ctrlSetStructuredText parseText format["%1",_message];
			};
			if(life_thirst > 50) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\drink2.paa'/>";
				_mydrink ctrlSetStructuredText parseText format["%1",_message];
			};
			if(life_thirst > 40) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\drink3.paa'/>";
				_mydrink ctrlSetStructuredText parseText format["%1",_message];
			};

			if(life_thirst > 30) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\drink4.paa'/>";
				_mydrink ctrlSetStructuredText parseText format["%1",_message];
			};
			if(life_thirst > 15) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\drink5.paa'/>";
				_mydrink ctrlSetStructuredText parseText format["%1",_message];
			};
			if(life_thirst > 0) exitwith {
				_message = "<img size='2.5' image='\OL_Textures\images\drink6.paa'/>";
				_mydrink ctrlSetStructuredText parseText format["%1",_message];
			};
		...
		{
			_message = "<img size='2' image='\OL_Textures\images\pizza.paa'/>";
		...
		if ( life_bro > 1 ) then
		{
			_message = "<img size='2' image='\OL_Textures\images\donuts.paa'/>";
		...
		if ( life_num > 1 ) then
		{
			_message = "<img size='2' image='\OL_Textures\images\energy.paa'/>";
		...
		if ( callInProgress || PhoneDisabled ) then
		{
			...
			if ( callInProgress ) then {
				_message = "<img size='2' image='\OL_Textures\images\phonecall.paa'/>";
			} else {
				_message = "<img size='2' image='\OL_Textures\images\nophone.paa'/>";
			};
		...
		{
			_message = "<img size='2' image='\OL_Textures\images\ears.paa'/>";
		...
		{
			_message = "<img size='2' image='\OL_Textures\images\record.paa'/>";
		...
		{
			_message = "<img size='2' image='\OL_Textures\images\druggedup.paa'/>";
		...
		{
			_message = "<img size='2' image='\OL_Textures\images\onweed.paa'/>";
		...
		{
			_message = "<img size='2' image='\OL_Textures\images\battery.paa'/>";
		...
		{
			_message = "<img size='2' image='\OL_Textures\images\toilet.paa'/>";
		...
		if ( has_job ) then
		{
			_message = "<img size='2' image='\OL_Textures\images\working.paa'/>";
			_tbewdgopro ctrlSetStructuredText parseText format["%1",_message];
		}
		else
		{
		...
		if ( vehicle player != player ) then
		{
			if(life_seatbelt) then {
				_message = "<img size='2' image='\OL_Textures\images\seatbelton.paa'/>";
				_tbewdgopro ctrlSetStructuredText parseText format["%1",_message];
			} else {
				_message = "<img size='2' image='\OL_Textures\images\seatbeltoff.paa'/>";
				_tbewdgopro ctrlSetStructuredText parseText format["%1",_message];
			};
		}
		else
	...
	if(!im_dead) then
	{
		...
		if(player getVariable["severeInjuries",FALSE]) then
		{
			...
			_injurytext = "Severe Pain";
			_severe_injury ctrlSetStructuredText parseText format["<img size='0.07' image='\OL_Textures\images\drugs.paa'/><t size='0.03px'> %1</t>",_injurytext];
		...
		if(koildeb > 1) then
		{
			...
			_bleeding ctrlSetStructuredText parseText format["<img size='0.07' image='\OL_Textures\images\head.paa'/><t size='0.03px'> %1</t>",_bleedingon];
		...
		if(koildebi > 1) then
		{
			...
			_wounded ctrlSetStructuredText parseText format["<img size='0.07' image='\OL_Textures\images\chest.paa'/><t size='0.03px'> %1</t>",_woundedon];
		...
		if(koildebii > 1) then
		{
			...
			_fracture ctrlSetStructuredText parseText format["<img size='0.07' image='\OL_Textures\images\arm.paa'/><t size='0.03px'> %1</t>",_fractureon];
		...
		if(koildebiii > 1) then
		{
			...
			_unconcious ctrlSetStructuredText parseText format["<img size='0.07' image='\OL_Textures\images\foot.paa'/><t size='0.03px'> %1</t>",_unconciouson];
		...
		if(koildebiiii > 1) then
		{
			...
			_disease ctrlSetStructuredText parseText format["<img size='0.07' image='\OL_Textures\images\sick.paa'/><t size='0.03px'> %1</t>",_diseaseon];
