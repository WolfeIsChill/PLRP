...
if(player distance (getMarkerPos "MARKER_JAIL") > 40) then
{
	player setPos (getMarkerPos "MARKER_JAIL");
};
...
if (life_inv_unprocessedlsd > 0) then { [false, "unprocessed_lsd", life_inv_unprocessedlsd] call life_fnc_handleInv };
