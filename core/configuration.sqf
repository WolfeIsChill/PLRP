...
LS_SD_Command         = false;
PLRP_LoggedIn         = false;
PLRP_BlacklistChecked = false;
PLRP_FirstSpawn       = true;
PLRP_BankPin          = [];
PLRP_CharacterInfo    = [];
PLRP_Actions          = [];
PLRP_StaffPanelItems  = [
  ["Delete",                [2, 3, 4, 5, 6, 7, 8]],
  ["Spectate (F3 to Quit)", [2, 3, 4, 5, 6, 7, 8]],
  ["Luke's Comp System",    [2, 3, 4, 5, 6, 7, 8]],

  ["Tags (inc. Vehicles)",  [4, 5, 6, 7, 8]],
  ["Teleport",              [4, 5, 6, 7, 8]],
  ["20 Dounts",             [4, 5, 6, 7, 8]],
  ["Heal/Repair (5M)",      [4, 5, 6, 7, 8]],
  ["Teleport 2 Me",         [4, 5, 6, 7, 8]],
  ["10M Clean Up",          [4, 5, 6, 7, 8]],

  ["GPS,NVG,BINOC",         [5, 6, 7, 8]],
  ["PGSpawn",               [5, 6, 7, 8]],
  ["World Heal",            [5, 6, 7, 8]],
  ["Server Cleaner",        [5, 6, 7, 8]],
  ["Global Comp. 100k",     [5, 6, 7, 8]]
];
...
*/
OL_CPBArray = [
  ["RoadBarrier_F",             9000,   [0, 2, 1]],
  ["RoadBarrier_small_F",       6000,   [0, 2, 1]],
  ["Land_CncBarrier_stripes_f", 9000,   [0, 2, 1]],
  ["Land_CncBarrier_F",         9000,   [0, 2, 1]],
  ["TapeSign_F",                5000,   [0, 2, 1]],
  ["plp_upm_PlasticBarrierRed", 9000,   [0, 2, 1]],
  ["Land_Bargate_F",            9500,   [0, 2, 1]],
  ["PlasticBarrier_03_orange_F",9000,   [0, 2, 1]],
  ["Land_BagFence_Long_F",      9000,   [0, 2, 1]],
  ["Land_BagFence_Corner_F",    9000,   [0, 2, 1]]
];
...
// Senior Admin
OL_Admin_4_G_Commands = [
  ""
];
// Developer
OL_Admin_5_G_Commands = [
  "Delete",
  "Spectate (F3 to Quit)",
  "Comp System",
  "Teleport",
