...
{	
	...
	{
	["You have packed up a fortified road block.", false] spawn domsg;
	...
	{
	["You have packed up a wooden road block.", false] spawn domsg;
	{deleteVehicle _x} foreach _roadblockobjects;
	};
};
	...
	{
	["You have packed up a rebel road block.", false] spawn domsg;
	{deleteVehicle _x} foreach _roadblockobjects;
	};
};
	default {nil};
