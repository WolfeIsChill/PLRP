...
{	
	...
	{
	["You have packed up a strip of blinking road cones.", false] spawn domsg;;
	...
	{
	["You have packed up a blinking road cone.", false] spawn domsg;
	{deleteVehicle _x} foreach _roadconesobjects;
	};
	};
};
	...
	{
	["You have packed up a strip of road cones.", false] spawn domsg;
	{deleteVehicle _x} foreach _roadconesobjects;
	};
	};
	if (count _roadconesobjects <= 1) then {
	...
	{
	["You have packed up a road cone.", false] spawn domsg;
	{deleteVehicle _x} foreach _roadconesobjects;
	};
	};
};
