...
while {true} do {
	...
	uisleep 1;
	hintSilent parsetext format["<img size='1' image='\OL_Textures\images\info.paa'/> <t color='#FFCC00'><t size='0.75'>JOB:</t><br/> You have taken %1 seconds. <br/> Needed: 1200 seconds total.",_calcT];
};
