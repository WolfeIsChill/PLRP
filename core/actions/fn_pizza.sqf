...
if(_item) then {
	...
	if(cash_in_hand < _price) exitWith { ["PIZZA GUY: Not enough money, I need $750 for this riperino pizza.", false] spawn domsg; _complete = true; };
...
["Mmm, Riperino Pizza... you now heal over time for 90 minutes.", false] spawn domsg;
...
["Riperino Pizza has run out... you no longer heal over time.", false] spawn domsg;
