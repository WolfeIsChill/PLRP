...
[0,format["%1 was just searched.",name player, _cop]] remoteExecCall ["life_fnc_broadcast", -2]; 
...
[localize "Searching Completed... all illegal items removed.", false] spawn domsg;
